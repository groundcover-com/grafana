...
const (
	...
	// GCIssueHeaderAnnotation holds the Jinja2 template for the alert issue header.
	// The template supports simple variable interpolation using {{ alert.labels.X }} syntax.
