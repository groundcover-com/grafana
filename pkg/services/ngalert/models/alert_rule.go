...
const (
	...
	// GCTemplateLanguageAnnotation specifies which template engine to use for annotations/labels.
	// Empty or missing uses Go text/template (legacy), "jinja2" uses Jinja2-compatible templating.
	GCTemplateLanguageAnnotation = "_gc_template_language"

	// TemplateLanguageJinja2 is the value for Jinja2 templating
	TemplateLanguageJinja2 = "jinja2"
)
