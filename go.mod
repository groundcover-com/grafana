...
// groundcover: pongo2 powers the Jinja2 summary templates in ngalert.
require github.com/flosch/pongo2/v6 v6.0.0

// groundcover: use our alerting fork which exposes silence queries (Mutes) on the Alertmanager.
replace github.com/grafana/alerting => github.com/groundcover-com/alerting v0.0.6
